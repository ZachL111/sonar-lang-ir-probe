"""Regression checks for the sonar-lang-ir-probe casebook."""
...
from casebook.harness import assert_expected, sonar_lang_ir_probe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(sonar_lang_ir_probe_summary(), assert_expected())
